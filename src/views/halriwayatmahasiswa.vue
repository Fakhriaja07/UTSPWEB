    ...
    <main id="home-page">
      ...
      <div v-if="isEditFormVisible" class="edit-form">
        ...
        <form @submit.prevent="editRow()">
          <label for="editTanggal">Tanggal Setoran:</label>
          <input type="text" v-model="editFormData.tanggal" id="editTanggal">
          <label for="editSurah">Surah:</label>
          <input type="text" v-model="editFormData.surah" id="editSurah">
          <label for="editAyat">Ayat:</label>
          <input type="text" v-model="editFormData.ayat" id="editAyat">
          <label for="editCatatan">Catatan:</label>
          <input type="text" v-model="editFormData.catatan" id="editCatatan">
